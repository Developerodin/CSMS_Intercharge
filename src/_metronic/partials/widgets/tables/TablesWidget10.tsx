    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 pt-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bold fs-3 mb-1'>Activity log</span>
          ...
          <table className='table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4'>
            ...
            <thead>
              <tr className='fw-bold text-muted'>
                ...
                <th className='min-w-140px'>CPO name</th>
                <th className='min-w-120px'>session started </th>
                <th className='min-w-100px text-end'>Actions</th>
                {/* <th className='min-w-100px text-end'>session started </th>
                <th className='min-w-100px text-end'>session end</th> */}
              </tr>
            </thead>
            {/* end::Table head */}
            {/* begin::Table body */}
